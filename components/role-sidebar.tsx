...
const menuItems: Record<UserRole, { href: string; label: string; icon: any }[]> = {
  admin: [
    ...
    { href: '/dashboard/finance', label: 'Finance Monitor', icon: DollarSign },
  ...
  student: [
    { href: '/dashboard', label: 'Dashboard', icon: LayoutDashboard },
    { href: '/dashboard/students', label: 'My Classes', icon: BookOpen },
    { href: '/dashboard/attendance', label: 'My Attendance', icon: ClipboardList },
    { href: '/dashboard/exams', label: 'My Marks', icon: FileBarChart2 },
    { href: '/dashboard/finance', label: 'Fee Status', icon: DollarSign },
    { href: '/dashboard/certificates', label: 'Certificates', icon: Award },
    { href: '/dashboard/announcements', label: 'Announcements', icon: Megaphone },
  ],
  parent: [
    { href: '/dashboard', label: 'Dashboard', icon: LayoutDashboard },
    { href: '/dashboard/students', label: 'Child Profile', icon: User },
    { href: '/dashboard/attendance', label: 'Attendance Summary', icon: ClipboardList },
    { href: '/dashboard/exams', label: 'Academic Performance', icon: BarChart3 },
    { href: '/dashboard/finance', label: 'Fee Payment', icon: DollarSign },
    { href: '/dashboard/announcements', label: 'Announcements', icon: Megaphone },
  ],
}
